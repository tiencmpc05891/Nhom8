                        ...
                        <div class="carousel-item position-relative active" style="height: 430px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <a class="btn btn-outline-light py-2 px-4 mt-3 animate__animated animate__fadeInUp" href="site/shop.php">Mua ngay</a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="content/img/iphone-15-pro-max-blue-1-1.jpg" alt="">
                    ...
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href="index.php?act=detail">IPhone 15 Pro Max 256GB</a>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5>25.000.000đ</h5><h6 class="text-muted ml-2"><del>25.000.000đ</del></h6>
                        </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    ...
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href="">IPhone 15 Pro Max 256GB</a>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5>25.000.000đ</h5><h6 class="text-muted ml-2"><del>25.000.000đ</del></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mb-1">
    ...
    <div class="container-fluid pt-5 pb-3">
        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="content/img/samsung-galaxy-s23-plus-xanh-1-1.jpg" alt="">
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="far fa-heart"></i></a>
                            <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-sync-alt"></i></a>
                    ...
                    <div class="text-center py-4">
                        <a class="h6 text-decoration-none text-truncate" href="">Samsung Galaxy S23+ 5G 256GB</a>
                        <div class="d-flex align-items-center justify-content-center mt-2">
                            <h5>25.000.000đ</h5><h6 class="text-muted ml-2"><del>25.000.000đ</del></h6>
                        </div>
                        <div class="d-flex align-items-center justify-content-center mb-1">
