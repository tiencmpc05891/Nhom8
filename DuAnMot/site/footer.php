 ...
 <div class="container-fluid bg-dark text-secondary mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt text-primary mr-3"></i>Cái Răng, TP.Cần Thơ</p>
            ...
            <div class="col-lg-8 col-md-12">
                <div class="row">
                    <div class="col-md-4 mb-5">
                        <h5 class="text-secondary text-uppercase mb-4">Mua sắm</h5>
                    ...
                    <div class="col-md-4 mb-5">
                        <h5 class="text-secondary text-uppercase mb-4">Gửi tin nhắn</h5>
                        <p></p>
                        <form action="">
                            <div class="input-group">
                                <input type="text" class="form-control" placeholder="Nhập tin nhắn của bạn">
        ...
        <div class="row border-top mx-xl-5 py-4" style="border-color: rgba(256, 256, 256, .1) !important;">
            <div class="col-md-6 px-xl-0">
                <p class="mb-md-0 text-center text-md-left text-secondary">
                    ...
                    by
                    <a class="text-primary" href="">DT HYU SHOP</a>
