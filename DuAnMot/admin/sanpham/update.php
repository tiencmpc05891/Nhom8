                        ...
                        <div class="card-body">
                            <form action="index.php?act=updatesp" method="post" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="level" class="col-form-label">Thông tin:</label>
                                        <textarea name="thongtin" id="" cols="30" rows="5" style="width:100%; border:1px #CCC solid" class="col-form-label"><?= $thongtin?></textarea>
                                    </div>
