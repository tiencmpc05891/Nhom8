...
if (isset($_GET['id'])) {
    ...
    $productDAO = new HangHoaDAO();

    // Use HangHoaDAO to retrieve product details
    $pdoConnection = new PDOConnection();
    $pdo = $pdoConnection->getConnection();
   

    $query = "SELECT hh.*, lh.TenLoaiHang 
              FROM hanghoa hh 
              JOIN loaihanghoa lh ON hh.MaLoaiHang = lh.MaLoaiHang 
              WHERE hh.MSHH = :id";
        ...
        <div class="row gx-5">
            <aside class="col-lg-6">
                <div class="border rounded-4 mb-3 d-flex justify-content-center">
                    <a data-fslightbox="mygallery" class="rounded-4" target="_blank" data-type="image" href="<?php echo $product['img']; ?>">
                        <img style="max-width: 100%; max-height: 100vh; margin: auto;" class="rounded-4 fit" src="<?php echo $product['img']; ?>" alt="Product Image" />
                    </a>
                </div>
            </aside>
            <main class="col-lg-6">
                <div class="ps-lg-3">
                    ...
                    <p>
                        Loại sản phẩm: <?php echo $product['TenLoaiHang']; ?>
                    </p>
                    <p>
                        Mô tả: <?php echo $product['GhiChu']; ?>
                    </p>
                    <hr />
                    <div class="row mb-4">
                        <!-- col.// -->
                    ...
                    <!-- Add buttons for buying, adding to cart, etc. -->
                    <a href="#" class="btn btn-warning shadow-0"> Mua ngay </a>
                    <a href="#" class="btn btn-primary shadow-0"> <i class="me-1 fa fa-shopping-basket"></i> Lưu vào giỏ hàng </a>
    ...
    <div class="border rounded-2 px-3 py-2 bg-white">
        ...
        <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
            <li class="nav-item d-flex" role="presentation">
                <a class="nav-link d-flex align-items-center justify-content-center w-100 active" id="ex1-tab-1" data-mdb-toggle="pill" href="#ex1-pills-1" role="tab" aria-controls="ex1-pills-1" aria-selected="true">Bình Luận</a>
            </li>
        </ul>
    ...
    <div class="comment-form">
        <form id="comment-form" method="post">
            <div class="form-group">
                ...
                <textarea id="comment-text" name="comment-text" class="form-control" required></textarea>
            </div>
    ...
    <div class="container">
        ...
        <div class="filters-content">
            <div class="row grid">
                ...
                // Thêm loaihanghoaDAO và lấy dữ liệu TenLoaiHang
                require_once '../dao/loaihanghoa.php';
                $loaiHangDAO = new LoaiHangHoaDAO();
                        ...
                        <div class="box">
                            <div>
                                ...
                                <div class="detail-box">
                                    <h5><?= $product['TenHH'] ?></h5>
                                    <?php
                                    // Lấy dữ liệu TenLoaiHang
                                    $loaiHangData = $loaiHangDAO->getLoaiHang($product['MaLoaiHang']);
                                    ?>
                                    <p><?= $loaiHangData['TenLoaiHang'] ?></p>
                                    <div class="options">
                                        <h6><?= $product['Gia'] ?> VND</h6>
                                        <?php
                                        if ($isLoggedIn) {
                                            echo '<a href="site/product_details.php?id=' . $product['MSHH'] . '">';
                                        } else {
                                            echo '<a href="javascript:void(0);" onclick="showAlertAndRedirect();">';
                                        }
                                        ?>
