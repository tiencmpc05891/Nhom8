...
<head>
  ...
  <link rel="shortcut icon" href="images/428001.png" type="">
...
<body>
  ...
  <div class="hero_area">
    <div class="bg-box">
      <img src="content/images/adm.jpg" alt="">
    </div>
        ...
        <nav class="navbar navbar-expand-lg custom_nav-container ">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item active">
              ...
              <li class="nav-item">
                <a class="nav-link" href="site/menu.php">Menu</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="site/checkout.php">Thanh toán</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="site/book.php">Liên hệ</a>
              </li>
            </ul>
            ...
            <nav>
              <?php if ($isLoggedIn): ?>
                  ...
                  if (isset($_SESSION['user'])) {
                      $user = $_SESSION['user'];
                      echo '<a href="site/profile.php">Chào ' . $user['HoTenKH'] . '   <i class="fa fa-user" aria-hidden="true"></i> </a>';
                  }
                  ?>
              <?php else: ?>
                  <a href="site/login.php"><i class="fa fa-user" aria-hidden="true"></i> Đăng nhập</a>
              <?php endif; ?>
            </nav>
              ...
              <form class="form-inline" action="site/searchform.php" method="get">
              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <p>
                      Macbook chính hãng, ưu đãi ngập tràn
                    </p>
                    <div class="btn-box">
                      <a href="" class="btn1">
                        Đặt ngay
      ...
      <div class="container ">
        <div class="row">
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="content/images/macbook-air-15-irl-04.webp" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Tasty Thursdays
          ...
          <div class="col-md-6  ">
            <div class="box ">
              <div class="img-box">
                <img src="content/images/akrales_211028_4820_0659.jpg" alt="">
              </div>
              <div class="detail-box">
                <h5>
                  Pizza Days
  ...
  <section class="about_section layout_padding">
    <div class="container  ">
      ...
      <div class="row">
        <div class="col-md-6 ">
          <div class="img-box">
            <img src="site/uploads/shuja-shuaib-banner (1).jpg" alt="">
          </div>
        </div>
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              Lựa chọn mẫu laptop yêu thích của bạn, hãy đến với xshop, nơi bạn sẽ lựa chọn cho mình được dòng laptop phù hợp với nhu cầu của bạn.
            </p>
            <a href="">
              Xem thêm
            </a>
