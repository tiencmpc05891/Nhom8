                ...
                <div class="bg-light p-4 mb-30">
                    <form>
                        ...
                        <div
                            ...
                            <label class="custom-control-label" for="color-1">Iphone</label>
                            <span class="badge border font-weight-normal">10</span>
                        </div>
                        <div
                            class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                        ...
                        <div
                            ...
                            <label class="custom-control-label" for="color-3">Xiaomi</label>
                            <span class="badge border font-weight-normal">5</span>
                        </div>
                        <div
                            class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
                            <input type="checkbox" class="custom-control-input" id="color-4">
                            <label class="custom-control-label" for="color-4">Vivo</label>
                            <span class="badge border font-weight-normal">5</span>
                        </div>
                        ...
                        <div class="product-item bg-light mb-4">
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>25.000.000đ</h5>
                                    <h6 class="text-muted ml-2"><del>25.000.000đ</del></h6>
                                </div>
