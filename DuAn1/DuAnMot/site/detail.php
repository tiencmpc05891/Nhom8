        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="content/img/iphone-15-pro-max-blue-1-1.jpg" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">25.000.000đ</h3>
                    <p class="mb-4"></p>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="media mb-4">
                                        <img src="content/img/iphone-11-trang-600x600.jpg" alt="Image" class="img-fluid mr-3 mt-1"
                                            style="width: 45px;">
            ...
            <div class="col">
                <div class="owl-carousel related-carousel">
                    <div class="product-item bg-light">
                        ...
                        <img class="img-fluid w-100"  src="content/img/iphone-11-trang-600x600.jpg" alt="">
                        ...
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="">iPhone 11 Promax</a>
