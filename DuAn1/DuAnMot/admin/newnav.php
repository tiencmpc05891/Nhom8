<style>
  ...
  .main-sidebar {
    position: relative;
    background: radial-gradient(circle, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('../view/img/footergalaxy.jpg');
    z-index: 1;
...
<aside class="main-sidebar sidebar-dark-pink elevation-4">
  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      <div class="image">
        <img src="../view/img/logoasm1.png" class="img-circle elevation-2" alt="User Image">
      </div>
      <div class="info">
        <a href="http://localhost:3000/index.php" class="d-block">Quay lại cửa hàng</a>
      </div>
    </div>
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="index.php?act=dsuser" class="nav-link">
        ...
        <li class="nav-item">
          <a href="index.php?act=logout" class="nav-link">
